...
public struct PaddleOtherSideSnapshotData : ISnapshotData<PaddleOtherSideSnapshotData>
{
    public uint tick;
    ...
    public void Serialize(int networkId, ref PaddleOtherSideSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref PaddleOtherSideSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref PaddleOtherSideSnapshotData target, float factor)
    {
