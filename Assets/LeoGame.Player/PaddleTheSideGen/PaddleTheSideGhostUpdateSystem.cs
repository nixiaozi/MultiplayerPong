...
public class PaddleTheSideGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#pragma warning restore 649
#endif
        [ReadOnly] public ArchetypeChunkBufferType<PaddleTheSideSnapshotData> ghostSnapshotDataType;
        ...
        public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
        {
            ...
            for (int entityIndex = 0; entityIndex < ghostEntityArray.Length; ++entityIndex)
            {
                ...
                PaddleTheSideSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<PaddleTheSideSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<PaddleTheSideSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<PaddleTheSideSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<PaddleTheSideSnapshotData>(true),
...
public partial class PaddleTheSideGhostSpawnSystem : DefaultGhostSpawnSystem<PaddleTheSideSnapshotData>
{
    struct SetPredictedDefault : IJobParallelFor
    {
        [ReadOnly] public NativeArray<PaddleTheSideSnapshotData> snapshots;
    ...
    protected override JobHandle SetPredictedGhostDefaults(NativeArray<PaddleTheSideSnapshotData> snapshots, NativeArray<int> predictionMask, JobHandle inputDeps)
    {
